PAA all phases winning models and quadratic term
================
Anne Margit
03/03/2021
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
plot_PAAp2 <- ggplot(as.data.frame(ef_PAAp2), aes(DaysMax_p2, fit, color=Age_new)) + 
  ...
  labs(title="Predicted PAA scores based on days since peak stringency",
       x="Days since peak stringency", y = "PAA") +
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
plot_PAAp2q <- ggplot(as.data.frame(ef_PAAp2q),  aes(DaysMax_p2_dev, fit, color=Age_new)) + 
  ...
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se), width=1) + 
  theme_minimal(base_size=12) + 
  labs(title="Quadratic association between PAA and days since peak stringency",
       x="Days since peak stringency", y = "PAA") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_discrete(name="Age", labels = c("18-24", "25-44", "45-64", "65+")) + 
  expand_limits(y=c(1, 5))
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
plot_PAAp3 <- ggplot(as.data.frame(ef_PAAp3), aes(DaysPhase3, fit, color=Age_new)) + 
  ...
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se), width=1) + 
  theme_minimal(base_size=12) + 
  labs(title="Predicted PAA scores based on days since decline in stringency",
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->
...
![](PAA-all-phases-winning-models-and-quadratic-term_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->
