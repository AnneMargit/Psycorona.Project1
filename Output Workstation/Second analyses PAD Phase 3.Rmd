---
title: "Second analyses PAD Phase 3"
author: "Anne Margit"
date: "10/15/2020"
...
*Random slope for Country and ID, no correlation between IC and S for ID + AR*
```{r, message=F, comment=NA}
...
*Random slope for Country and ID, no correlation between IC and S for ID and Country + AR*
```{r, message=F, comment=NA}
...
*Random slope for Country and ID, no correlation between IC and S for Country + AR*
```{r, message=F, comment=NA}
...
> There are only differences between youngest (control) age group and the oldest. Interaction effects for all age groups x DaysMax
