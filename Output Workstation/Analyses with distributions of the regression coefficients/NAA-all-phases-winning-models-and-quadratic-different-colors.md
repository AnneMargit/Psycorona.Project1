...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
plot_NAAp1 <- ggplot(as.data.frame(ef_NAAp1), 
  ...
  labs(title="NAA before peak stringency", y = "NAA") +
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
plot_NAAp2 <- ggplot(as.data.frame(ef_NAAp2), aes(DaysMax_p2, fit, color=Age_new)) + 
  ...
  labs(title="NAA trajectories during peak stringency",
       x="Days since start peak stringency", y = "NAA") +
  theme(plot.title = element_text(hjust = 0.5)) +
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
plot_NAAp2_slope <- ggplot(data2, aes(x= DaysMax_p2.y, fill = ..x..)) +
 ...
 scale_fill_viridis(option = "C")+
  ...
  geom_vline(xintercept = 0, linetype="dashed", 
                color = "black", size=.5) + 
  labs(title="Variability in NAA trajectories during peak stringency",
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
plot_NAAp2q <- ggplot(as.data.frame(ef_NAAp2q), aes(DaysMax_p2_dev, fit, color=Age_new)) + 
  ...
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se), width=1) + 
  theme_minimal(base_size=12) + 
  labs(title="Quadratic NAA trajectories during peak stringency",
       x="Days since start peak stringency (centered)", y = "NAA") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_discrete(name="Age", labels = c("18-24", "25-44", "45-64", "65+")) + 
  expand_limits(y=c(1, 5))
```
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
plot_NAAp3 <- ggplot(as.data.frame(ef_NAAp3), aes(DaysPhase3, fit, color=Age_new)) + 
  ...
  geom_errorbar(aes(ymin=fit-se, ymax=fit+se), width=1) + 
  theme_minimal(base_size=12) + 
  labs(title="NAA trajectories since decline in stringency",
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-38-1.png)<!-- -->
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-43-1.png)<!-- -->
...
plot_NAAp3_slope <- ggplot(data2, aes(x= DaysPhase3.y, fill = ..x..)) +
 ...
 scale_fill_viridis(option = "C") +
  ...
  theme(legend.position="none") + 
   geom_vline(xintercept = 0, linetype="dashed", 
                color = "black", size=.5) + 
  labs(title="Variability in NAA trajectories after peak stringency",
       x="Regression coefficient (NAA ~ days)", y = "Count") +
  theme(plot.title = element_text(hjust = 0.5)) +
   facet_wrap(~ Age_new, labeller = labeller(Age_new = Age_labels)) 
```
...
![](NAA-all-phases-winning-models-and-quadratic-different-colors_files/figure-gfm/unnamed-chunk-45-1.png)<!-- -->
