---
title: "Second analyses NAD Phase 2"
author: "Anne Margit"
date: "10/14/2020"
...
*Random: IC for ID and Country, S for ID, no cor between IC and S for ID + Autocorrelation structure*
```{r, message=F, comment=NA}
...
> Best model is NAD6: random IC for ID and Country + S for ID + Autocorrelation structure*
...
> There are differences between age groups in intensity but no change over time
