---
title: "Second analyses PAA Phase 2"
author: "Anne Margit"
date: "10/14/2020"
...
> Best model is PAA8: random IC for ID and Country + S for ID + no correlation between IC and S for ID + AR*
...
> There are differences between age groups in intensity, PAA also increases with increasing days after max stringency. Small effect sizes 
> There are also interaction effects between age and DaysMax but these effect sizes are small. 
