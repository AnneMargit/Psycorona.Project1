...
data_long_min3_str$Date <- as.Date(data_long_min3_str$Date)

data_long_min3_str$Country <- as.factor(data_long_min3_str$Country)

data_long_min3_str <- data_long_min3_str[with(data_long_min3_str, order(StringencyIndex, Date)),]

MaxStr <- data_long_min3_str %>% 
