...
Stringency_data2 <- Stringency_data %>%
  group_by(Country) %>%
...
Stringency_data2$Date <- as.Date(Stringency_data2$Date)

data_long_min3_str <- left_join(data_long_min3_20, Stringency_data2, by=c("Country", "Date"))
