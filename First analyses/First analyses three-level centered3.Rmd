...
> Model NAA10 has the best fit (lowest BIC). This model has random slopes for Stringency at the Country level and ID level, assumes no correlation between random slope and intercept, and assumes autoregressive correlation structure at the measurement level. 
